 ...
 * 
 * @author M. Coninx Represente la position (coordonnees et orientation) d'un
 *         robot a deux roues
 */
public class Pos implements Cloneable {
	 ...
	 */
	public Pos move(double dl, double dr, double ecartRoues) {
		...
		if (alpha > 1e-20 || alpha < -1e-20) {
			...
			p = new Pos(dl * Math.cos(this.getTheta()), dl
